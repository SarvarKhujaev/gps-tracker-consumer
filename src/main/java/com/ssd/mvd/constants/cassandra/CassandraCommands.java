...
import com.ssd.mvd.annotations.LinksToDocs;
...
public final class CassandraCommands {
    ...
    @LinksToDocs(
            links = "https://foundev.medium.com/domain-modeling-around-deletes-1cc9b6da0d24"
    )
    ...
    @LinksToDocs( links = "https://docs.datastax.com/en/dse/6.0/cql/cql/cql_using/useInsertJSON.html" )
    public static final String JSON = "JSON";

    @SuppressWarnings(
            value = "Use the DEFAULT UNSET option to only overwrite values found in the JSON string:"
    )
    ...
    @LinksToDocs( links = "https://docs.datastax.com/en/dse/6.0/cql/cql/cql_using/useTTL.html" )
    ...
    public static final String WITH_COMPACTION = "compaction = { 'class' : '%s' }";

    public static final String WITH_CLUSTERING_ORDER = "CLUSTERING ORDER BY ( %s )";
    ...
    @LinksToDocs( links = "https://docs.datastax.com/en/dse/6.0/cql/cql/cql_using/useTTL.html <- link for docs" )
    @SuppressWarnings( value = "TTL FUNCTIONS" )
